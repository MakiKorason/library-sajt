...
Ово је књига којој ћемо се радо враћати након првог читања.
                ...
                {activeKey === 'jun' && (
                  <Row>
                    <Col xs={12} sm={12} md={4} lg={4} xl={4} className=" text-center mt-4">
                      <img src="https://pulse.rs/wp-content/uploads/2021/10/Milica-Vuckovic.-Fotografija-preuzeta-sa-nova.rs_.jpg" className="container-image" alt='Смртни исход атлетских повреда' referrerPolicy="no-referrer" loading="lazy" width="300" height="450" />
                      <br/><br/>
                      <Button
                        variant="secondary"
                ...
                {activeKey === 'jul' && (
                  <Row>
                    <Col xs={12} sm={12} md={4} lg={4} xl={4} className=" text-center mt-4"> 
                      <a 
                        href="https://delfi.rs/_img/artikli/2022/11/psihijatri_psiholozi_i_drugi_bolesnici_vv.jpg" 
                        target="_blank" 
                        rel="noopener noreferrer"
                        aria-label="Психијатри, психолози и други болесници - корица књиге"
                        title="Психијатри, психолози и други болесници - Родриго Муњос Авиа"
                      >
                        <img 
                          src="https://delfi.rs/_img/artikli/2022/11/psihijatri_psiholozi_i_drugi_bolesnici_vv.jpg" 
                          alt="Психијатри, психолози и други болесници - корица књиге Родрига Муњоса Авие, препорука библиотекара"
                          title="Психијатри, психолози и други болесници - Родриго Муњос Авиа"
                          className="container-image"
                          loading="lazy"
                          width="300"
                ...
                {activeKey === 'avgust' && (
                  <Row>
                    <Col xs={12} sm={12} md={4} lg={4} xl={4} className=" text-center mt-4">
                      <a 
                        href="https://www.vulkani.rs/files/thumbs/files/images/slike_proizvoda/thumbs_1200/26309_1200_1200px.jpg" 
                        target="_blank" 
                        rel="noopener noreferrer"
                        aria-label="Жена са цветом од папира - корица књиге"
                        title="Жена са цветом од папира - Донато Каризи"
                      >
                        <img 
                          src="https://www.vulkani.rs/files/thumbs/files/images/slike_proizvoda/thumbs_1200/26309_1200_1200px.jpg" 
                          alt="Жена са цветом од папира - корица књиге Доната Каризија, препорука библиотекара"
                          title="Жена са цветом од папира - Донато Каризи"
                          className="container-image"
                          loading="lazy"
                          width="300"
                ...
                {activeKey === 'oktobar' && (
                  <Row>
                    <Col xs={12} sm={12} md={4} lg={4} xl={4} className=" text-center mt-4">
                      <a 
                        href="https://www.vulkani.rs/files/thumbs/files/images/slike_proizvoda/thumbs_1200/22395_1200_1200px.jpg" 
                        target="_blank" 
                        rel="noopener noreferrer"
                        aria-label="Ако сутра не постоји - корица књиге"
                        title="Ако сутра не постоји - Гијом Мусо"
                      >
                        <img 
                          src="https://www.vulkani.rs/files/thumbs/files/images/slike_proizvoda/thumbs_1200/22395_1200_1200px.jpg" 
                          alt="Ако сутра не постоји - корица књиге Гијома Мусоа, препорука библиотекара"
                          title="Ако сутра не постоји - Гијом Мусо"
                          className="container-image"
                          loading="lazy"
                          width="300"
                    ...
                    <Col xs={12} sm={12} md={8} lg={8} xl={8} className="mt-4">
                      <p className="container-text">Препорука за октобар:<br/>
                        Ако тражите узбудљиво и незаборавно читање за овај месец, препоручујемо роман Гијома Мусоа „Ако сутра не постоји". Ово је љубавни роман са елементима трилера и детективске приче, прожет фантастиком, који оставља дубок траг у души читаоца. Књига показује да је, у животу као и у причи, све могуће.
                      </p>
                      <Button
                        variant="secondary"
                ...
                {activeKey === 'septembar' && (
                  <Row>
                    <Col xs={12} sm={12} md={4} lg={4} xl={4} className=" text-center mt-4">
                      <a 
                        href="https://dereta.rs/cached/dereta.rs/Images/Pesma-o-tri-sveta-228x0-00000414110.jpg" 
                        target="_blank" 
                        rel="noopener noreferrer"
                        aria-label="Песма о три света - корица књиге"
                        title="Песма о три света - Владимир Пиштало"
                      >
                        <img 
                          src={pesmaOTriSveta}
                          alt="Песма о три света - корица књиге Владимира Пиштала, препорука библиотекара"
                          title="Песма о три света - Владимир Пиштало"
                          className="container-image"
                          loading="lazy"
                          width="300"
